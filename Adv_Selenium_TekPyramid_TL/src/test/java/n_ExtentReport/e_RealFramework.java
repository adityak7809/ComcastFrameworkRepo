...
public class e_RealFramework extends a_BaseClass{
	...
	public void createOrg_Test() throws InterruptedException, IOException {
		...
		if (actText.contains(orgName)) {
			...
			UtilityClassObject.getTest().info("Org name verified");
		} else {
			System.out.println(orgName + " is not created==FAIL");
			UtilityClassObject.getTest().info("Org name verification failed");
		}
		...
		if (actOrgName.equals(orgName)) {
			...
			UtilityClassObject.getTest().info("Org name displayed successfully");
		} else {
			System.out.println("Organization name is not displayed==FAIL");
			UtilityClassObject.getTest().info("Org name not displayed");
		}
